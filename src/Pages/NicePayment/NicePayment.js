...
const clickEvent = () => {
    console.log(document['pay-form']);
    document['pay-form'].submit();
};
...
const requestData = {
  ...
  const form = React.createElement('form', {name: 'pay-form', action: "https://web.nicepay.co.kr/v3/v3Payment.jsp", acceptCharset: "euc-kr"}, childElements);
  ReactDOM.createRoot(document.getElementById('payment-div')).render(form);

// const NicePayment = ({requestData}) => {

// };

// export default NicePayment;
