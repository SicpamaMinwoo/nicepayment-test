...
const RETURN_URL = "https://payment-be-project.herokuapp.com/payments/samsung-payment";
const DIRECT_PAYMENT_TYPE = "Samsung Pay";

const SamsungPayment = () => {
    const today = new Date();

    const mid = "nicessp06m";
    const merchantKey = "+iz0ov8wQDjOQ73GhO6QJ/kXF041yRiS+ERc3rD36Oe62onynMp0u0+ZvmKcBw2EKd2LlRcxJqbHBz313h0aJg==";
    ...
    return (
      <div className="Payment">
        ...
        <form onSubmit={nicepayStart} name="payForm" method="post" action={RETURN_URL} acceptCharset="euc-kr">
          ...
          <input type="hidden" name="DirectEasyPay" value="E021"/>
          {/* <input type="hidden" name="NicepayReserved" value="SamPayShopInt=1"/> */}
        </form>
      </div>
    );
};
